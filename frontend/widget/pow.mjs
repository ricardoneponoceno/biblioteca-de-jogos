/**
 * Proof-of-work solver for the per-site bot-protection gate.
 *
 * The server issues { salt, difficulty }; we find a nonce whose
...
/** SHA-256 of a byte array, returning a 32-byte Uint8Array. */
function sha256(bytes) {
  ...
  // 64-bit big-endian length in the final 8 bytes (message fits in 32 bits here).
